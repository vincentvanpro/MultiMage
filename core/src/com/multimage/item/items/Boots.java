...
public class Boots extends Item {
    ...
    /*The amount of this item in inventory will increase the movement speed of it's owner by 10%.
    Stacks +5%.
    */
    public Boots(PlayScreen screen, float x, float y) {
        super(screen, x, y);
        TextureAtlas atlas = new TextureAtlas("ui/items.pack");
        setRegion(atlas.findRegion("boots"), 0, 0, 32, 32);
        velocity = new Vector2(0, 0);
    }

    public Boots(MultiPlayer screen, float x, float y) {
        super(screen, x, y);
        TextureAtlas atlas = new TextureAtlas("ui/items.pack");
        setRegion(atlas.findRegion("boots"), 0, 0, 32, 32);
        velocity = new Vector2(0, 0);
